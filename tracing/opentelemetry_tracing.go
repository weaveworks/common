...
func NewOpenTelemetryTracerProvider(serviceName string) (*tracesdk.TracerProvider, error) {
...
func ExtractOpentelemetryTraceID(ctx context.Context) (string, bool) {
	traceId := trace.SpanContextFromContext(ctx).TraceID().String()
	return traceId, traceId != ""
}

func ExtractOpentelemetrySampledTraceID(ctx context.Context) (string, bool) {
	traceID := trace.SpanContextFromContext(ctx).TraceID().String()
	if traceID != "" {
